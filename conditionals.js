...
if(username){
    console.log(`Hello ${username}, my name is Conner. I am the android sent by Cyberlife.`)
}
else{
...
if(item == jacket){
    ...
    console.log(`You have ${money} munny left.`);
...
const randomPerson = Math.random() > .5 ? "Gabriel" : "Oscar"; 
